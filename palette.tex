...
\makeatother
\begin{document}
  \colorbox{MaterialGreen}{%
    \parbox[b][12\baselineskip]{10em}{%
      \bfseries\sffamily\color{white}
      \vspace*{1em}
      \hspace*{.5em} MaterialGreen
      \vfill
      \hspace{.5em} \printcolorvalue{MaterialGreen}
      \vspace*{1em}
    }
  }
  \colorbox{MaterialGreen600}{\parbox[b][10\baselineskip]{8em}{\hspace{1em}\ttfamily\color{white}\printcolorvalue{MaterialGreen600}\vspace*{1em}}}
